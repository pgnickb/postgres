...
DATA(insert OID = 3409 (  nextval			PGNSP PGUID 12 1 0 0 0 f f f f t f v u 2 0 2249 "2205 20" "{2205,20,20,20,20,20}" "{i,i,o,o,o,o}" "{sequence_oid,multi,count,first_value,last_value,increment}" _null_ _null_ nextval_multi _null_ _null_ _null_));
DESCR("call nextval multiple times");
